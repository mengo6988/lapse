...
/**
 * jsdom has no IntersectionObserver at all (unlike PointerEvent, which
 * exists but drops properties) — the real implementation is exercised via
 * this fake, which captures the callback each instance was constructed
 * with so a test can fire it manually, standing in for the browser
 * actually scrolling the sentinel into view.
 */
