 ...
 * for a Tracker without Variants — same flattening rule as the active list,
 * docs/spec.md § Domain rules), "unarchive", and "delete". Unarchive reuses
 ...
 * cache merge) rather than a bespoke hook — this ticket's file fence permits
 * importing it. Delete only opens the confirmation; ArchivedRoute owns the
 * dialog itself, so at most one is ever mounted for the whole screen.
 */
